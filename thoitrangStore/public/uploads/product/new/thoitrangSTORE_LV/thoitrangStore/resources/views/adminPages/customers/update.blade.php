    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    @if(!empty($khachhang))
                        <form class="form-horizontal form-material" action="{{route('admin.customers.store')}}"
                              method="POST">
                            @csrf
                            <input type="text" class="form-control p-0 border-0" value="{{$khachhang->id}}" name="id"
                                   hidden>

                            <div class="form-group mb-4">
                                <label class="col-md-12 p-0"><b>Tên Khách hàng</b><span
                                        style="color: red"> *</span></label>
                                <div class="col-md-12 border-bottom p-0">
                                    <input type="text" class="form-control p-0 border-0" value="{{$khachhang->hovaten}}"
                                           name="hovaten" required disabled></div>
                            </div>

                            <div class="form-group mb-4">
                                <label for="example-email" class="col-md-12 p-0"><b>Email Khách hàng</b><span
                                        style="color: red"> *</span></label>
                                <div class="col-md-12 border-bottom p-0">
                                    <input type="email" class="form-control p-0 border-0" value="{{$khachhang->email}}"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="col-md-12 border-bottom p-0">
                                    <input type="text" class="form-control p-0 border-0" value="{{$khachhang->diachi}}"
                                           name="diachi">
                                </div>
                            </div>
