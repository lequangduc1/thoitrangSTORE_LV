                ...
                <div class="sidebar-filter margin-bottom-25">
                    ...
                    <div class="checkbox-list">
                        @foreach($allColor as $color)
                            <a href="javascript:void(0)" class="filter">
                                <span class="filter__color filter__option"
                                      data-color="color_{{$color->id}}"
                                      style="background-color: {{$color->tenmau}};"
                                ></span>
                            </a>
                        @endforeach
                    </div>
                    ...
                    <div class="checkbox-list">
                        @foreach($allSize as $size)
                            <a href="javascript:void(0)" class="filter">
                                <span class="filter__size filter__option"
                                      data-size="size_{{$size->id}}"
                                >
                                    {{$size->tensize}}
                                </span>
                            </a>
                ...
                <div class="row product-list" style="min-height: 500px">
                    ...
                    @foreach($allProduct as $product)
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 product-wrapper">
                            <div class="product-item" data-size="size_{{$product->idsize}}"
                                 data-color="color_{{$product->idmau}}">
