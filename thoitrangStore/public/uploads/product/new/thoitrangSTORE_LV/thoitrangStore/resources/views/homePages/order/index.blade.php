                        ...
                        <div id="confirm-content" class="panel-collapse collapse">
                            <div class="panel-body row">
                                <div class="col-md-12 clearfix">
                                    ...
                                    <button class="btn btn-primary pull-right" type="submit" id="button-confirm">Xác
                                        nhận
                                    </button>
                                    <button type="button" class="btn btn-default pull-right margin-right-20">Hủy
                                    </button>
                                </div>
                            </div>
                        </div>
