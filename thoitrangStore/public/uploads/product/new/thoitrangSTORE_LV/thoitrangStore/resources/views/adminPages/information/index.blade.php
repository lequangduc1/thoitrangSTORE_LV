                            ...
                            <div class="col-6">
                                <div class="image-review">
                                    @if(getInformation('logo'))
                                        <img id="image__logo-review" src="{{asset(getInformation('logo'))}}"
                                             alt="logo"/>

                                    @else
                                        <img id="image__logo-review" src="{{asset('uploads/logo_default.png')}}"
                                             alt="logo"/>
                                    @endif
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-6">
                                <div class="image-review">
                                    @if(getInformation('favicon'))
                                        <img id="image__favicon-review" src="{{asset(getInformation('favicon'))}}"
                                             alt="logo"/>

                                    @else
                                        <img id="image__favicon-review" src="{{asset('uploads/logo_default.png')}}"
                                             alt="logo"/>
                                    @endif
                                </div>
                                <div class="mb-3">
