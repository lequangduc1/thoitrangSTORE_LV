                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="price-availability-block clearfix">
                                <div class="price">
                                    <strong id="product_detail_price">{{number_format($productDetail->giasanpham)}}
                                        VNĐ</strong>
                                ...
                                <div class="pull-left">
                                    ...
                                    <select
                                        ...
                                        @foreach($colors as $color)
                                            <option
                                                {{$color->id == $color_id ? 'selected' : ''}} value="{{$color->id}}">
                                                {{$color->tenmau}}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <div class="tab-pane fade in active" id="Reviews">
                                    ...
                                    @if(\Illuminate\Support\Facades\Auth::guard('customer')->check())
                                        <form method="POST" action="{{route('home.product.add_comment')}}"
                                              class="reviews-form" role="form">
                                            @php
                                    ...
                                    @else
                                        <strong>Bạn cần <a href="{{route('home.auth.login_form')}}">login</a> để được
                                            bình luận!</strong>
                                    @endif
                                    <!-- END FORM-->
                                </div>
                            ...
                            <div>
                                <div class="product-item">
                                    <div class="pi-img-wrapper">
                                        <img src="{{asset('system/homePages/assets/pages/img/products/k1.jpg')}}"
