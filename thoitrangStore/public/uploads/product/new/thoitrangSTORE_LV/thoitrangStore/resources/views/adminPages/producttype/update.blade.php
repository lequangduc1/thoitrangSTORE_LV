    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form class="form-horizontal form-material" action="{{route('admin.producttype.store')}}"
                          method="POST">
                        @csrf
                        <input type="text" class="form-control p-0 border-0" name="id" value="{{$productType->id}}"
                               hidden>
                        <div class="form-group mb-4">
                            <label class="col-md-12 p-0"><b>tên loại </b><span class="input__required">*</span></label>
                            <div class="col-md-12 border-bottom p-0">
                                <input type="text" class="form-control p-0 border-0" name="tenloai"
                                       value="{{$productType->tenloai}}">
                            </div>
                        </div>
                        <div class="form-group mb-4">
