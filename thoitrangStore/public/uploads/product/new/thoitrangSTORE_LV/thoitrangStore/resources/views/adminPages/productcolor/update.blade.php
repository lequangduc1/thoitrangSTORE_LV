    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form class="form-horizontal form-material" action="{{route('admin.productcolor.store')}}"
                          method="POST">
                        @csrf
                        <input type="text" class="form-control p-0 border-0" name="id" value="{{$productColor->id}}"
                               hidden>
                        <div class="form-group mb-4">
                            <label class="col-md-12 p-0"><b>tên màu </b><span class="input__required">*</span></label>
                            <div class="col-md-12 border-bottom p-0">
                                <input type="text" class="form-control p-0 border-0" name="tenmau"
                                       value="{{$productColor->tenmau}}">
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <label class="col-md-12 p-0"><b>code </b><span class="input__required">*</span></label>
                            <div class="col-md-12 border-bottom p-0">
                                <input type="color" class="form-control p-0 border-0" name="code"
