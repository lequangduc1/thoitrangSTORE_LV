                ...
                @if($phieunhap)
                    <div class="card-body" style="border: 1px solid #000; border-radius: 10px">
                        ...
                        <div class="form-horizontal form-material">
                            ...
                            <div class="form-group mb-4">
                                <label class="col-md-12 p-0"><b>Tổng tiền đơn hàng: </b><?php echo number_format($phieunhap->tongtien)?> VNĐ</label>
                            </div>
                            <div class="form-group mb-4">
                    ...
                    @if(!is_array($chitietphieunhap))
                        <div class="card-body" style="border: 1px solid #000; margin-top: 10px; border-radius: 10px" >
                            <label class="col-md-12 p-0 text-center"><b>Sản phẩm ({{count($chitietphieunhap)}})</b></label>
                                @foreach($chitietphieunhap as $key => $value)
                                    <div class="card-body col-md-6" style="border: 1px solid #000; margin-top: 10px; border-radius: 10px; float: left" >
                                        <div class="form-horizontal form-material">
                                            ...
                                            <div class="form-group col-md-12" style="float: left">
                                                <label class="col-md-12 p-0"><b>Tên sản phẩm: </b>  {{$value->chitietsanphams->sanphams->ten_sp}}</label>
                                            </div>
                                            <div class="form-group col-md-12" style="float: left">
                                                <label class="col-md-12 p-0"><b>Tên sản phẩm: </b>  {{$value->chitietsanphams->sizes->tensize}}</label>
                                            </div>
                                            <div class="form-group col-md-12" style="float: left">
                                            ...
                                            <div class="form-group col-md-12" style="float: left">
                                                <label class="col-md-12 p-0"><b>Số lượng: </b> <?php echo number_format($value->gianhap)?> VNĐ</label>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
