        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <div class="d-md-flex">
                    ...
                    <a href="{{route('admin.importcoupon.create')}}" class="btn btn-primary  d-none d-md-block pull-right ms-3 hidden-xs hidden-sm waves-effect waves-light text-white">
                      Nhập hàng
                    </a>
                </div>
            </div>
                            ...
                            @if(!is_array($phieunhap))
                                @foreach($phieunhap as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.importcoupon.detail', $value->id)}}"><span class="icon-action"><i class="fa fa-edit" aria-hidden="true"></i></span></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
