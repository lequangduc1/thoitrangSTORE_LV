        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <div class="d-md-flex">
                    ...
                    <a href="{{route('admin.producttype.create')}}" class="btn btn-primary  d-none d-md-block pull-right ms-3 hidden-xs hidden-sm waves-effect waves-light text-white">
                        Thêm loại sản phẩm
                    </a>
                </div>
            </div>
                            ...
                            @if(!is_array($productTypes))
                                @foreach($productTypes as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.producttype.update', $value->id)}}"><span class="icon-action"><i class="fa fa-edit" aria-hidden="true"></i></span></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
