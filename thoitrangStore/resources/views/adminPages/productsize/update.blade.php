    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form class="form-horizontal form-material" action="{{route('admin.productsize.store')}}" method="POST">
                        @csrf
                        <input type="text" class="form-control p-0 border-0" name="id" value="{{$productSizes->id}}" hidden>
                        <div class="form-group mb-4">
                            <label class="col-md-12 p-0"><b>Kích thước </b><span class="input__required">*</span></label>
                            <div class="col-md-12 border-bottom p-0">
                                <input type="text" class="form-control p-0 border-0" name="tensize" value="{{$productSizes->tensize}}">
                            </div>
                        </div>
                        <div class="form-group mb-4">
