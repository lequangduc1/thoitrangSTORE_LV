        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" action="{{route('admin.promotion.store')}}" method="POST">
                    @csrf
                    <input type="text" class="form-control p-0 border-0" value="{{$promotion->id}}" name="id" hidden>
            </div>

            <div class="form-group mb-4">
                <label class="col-md-12 p-0">Tên khuyến mãi<span style="color: red"> *</span></label>
                <div class="col-md-12 border-bottom p-0">
                    <input type="text" class="form-control p-0 border-0" value="{{$promotion->ten_km}}" name="ten_km" required>
                </div>
            </div>
