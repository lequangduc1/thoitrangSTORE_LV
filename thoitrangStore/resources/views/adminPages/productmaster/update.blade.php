    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form class="form-horizontal form-material" action="{{route('admin.product_master.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="col-md-12 border-bottom p-0">
                                <input type="text" class="form-control p-0 border-0" value="{{$products->ten_sp}}" name="ten_sp" />
                            </div>
                        </div>
                        <div class="form-group mb-4 col-sm-6" style="float: left">
                            ...
                            <div class="col-md-12 border-bottom p-0">
                                <input type="text" class="form-control p-0 border-0" name="macodesanpham"  value="{{$products->macodesanpham}}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="col-md-12 border-bottom p-0">
                                <input type="text" class="form-control p-0 border-0" name="mota"  value="{{$products->mota}}"/>
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <div class="col-sm-12">
